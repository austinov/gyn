...
INSERT INTO uteruse_states (name) VALUES ('невозбудима при пальпации'), ('слегка возбудима при пальпации'), ('возбудима при пальпации'), ('в гипертонусе');
...
CREATE TABLE IF NOT EXISTS appointments (
    ...
    "infection_markers_desc"    varchar(500),
    "tromboflebia_state_id"     integer,
    "tromboflebia_desc"         varchar(1000),
    ...
    "exp_by_menstruation"       varchar(500),
    "exp_by_first_visit"        varchar(500),
    "exp_by_ultra_first"        varchar(500),
    "exp_by_ultra_second"       varchar(500),
    "exp_by_ultra_third"        varchar(500),
    ...
    "peritoneal"                varchar(500),
    "labors"                    varchar(500),
    "dysuric"                   boolean,
    "bowel"                     boolean,
    "limb_swelling"             varchar(500),
    ...
    "arches"                    varchar(500),
    "conjugate"                 varchar(500),
    "pelvis_state_id"           integer,
    "pelvis_exostosis"          varchar(500),

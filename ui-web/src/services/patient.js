...
function _getDefaultData() {
    let bishop = 'Шейка матки (оценка по Бишопу  сумма баллов): ';
    bishop += 'отклонена несколько кзади (0 баллов), кпереди (1 балл), центрирована (2 балла),';
    bishop += 'плотная (0 баллов), умеренно размягчена (1 балл), мягкая (2 балла), ';
    bishop += 'укорочена до 1,5-2,0см (>2см 0 баллов, 1-2 см 1 балл, <1см 2 балла).\n';
    bishop += 'Наружный зев пропускает кончик пальца, закрыт (0 баллов).\n';
    bishop += 'Цервикальный канал проходим для  п/пальца (1п.п. до внутреннего зева 1 балл, 1п.п.свободно и > 2 балла).';
